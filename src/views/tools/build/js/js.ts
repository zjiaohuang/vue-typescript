...
import { titleCase, deepClone } from '@/utils/index'
...
export function makeUpJs(formConfig:any, type:any) {
  ...
  const ruleList:Array<any> = []
  const optionsList:Array<any> = []
  const propsList:Array<any> = []
  const methodList = mixinMethod(type)
  const uploadVarList:Array<any> = []
...
// 构建组件属性
function buildAttributes(scheme:any, dataList:any, ruleList:any, optionsList:any, methodList:any, propsList:any, uploadVarList:any) {
