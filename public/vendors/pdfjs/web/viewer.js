...
var PDFViewerApplication = {
  ...
  get page() {
    if(window.parent.pdfPageChange){
      var _that = this
      if(window.pdfTimeout && window.pdfTimeout !== null)
        clearTimeout(window.pdfTimeout);
      window.pdfTimeout = setTimeout(function(){
        console.log(`当前页面：${_that.pdfViewer.currentPageNumber}`)
        window.parent.pdfPageChange(_that.pdfViewer.currentPageNumber, _that.pagesCount);
      }, 500);
    }
